...
class SmartGuardrailSelector:
    ...
    TASK_GUARDRAIL_MAP = {
        ...
        "authentication": ["core/always.md", "core/security_baseline.md", "specialized/auth_security.md"],
    ...
    KEYWORD_MAP = {
        "core/always.md": {
            "architecture", "testing", "security", "quality", "documentation",
            "compliance", "workflow", "mandatory", "universal", "required"
        },
        "core/security_baseline.md": {
            "mfa", "azure", "rbac", "authentication", "authorization", "audit",
            "security", "token", "session", "permission", "access"
        },
        "core/testing_baseline.md": {
            "test", "coverage", "unit", "e2e", "mock", "assertion", "regression",
            "integration", "testing", "validation"
        },
        "specialized/auth_security.md": {
            "mfa", "azure", "ad", "active directory", "rbac", "role", "permission",
            "jwt", "session", "oauth", "sso", "saml", "authentication", "login"
        },
        "specialized/database_design.md": {
            "database", "schema", "table", "migration", "index", "constraint",
            "foreign key", "normalization", "sql", "query", "transaction"
        },
        "specialized/api_patterns.md": {
            "api", "endpoint", "rest", "http", "request", "response", "json",
            "get", "post", "put", "patch", "delete", "versioning"
        },
        "specialized/ui_accessibility.md": {
            "ui", "component", "accessibility", "wcag", "aria", "responsive",
            "mobile", "keyboard", "screen reader", "contrast", "semantic"
        },
        "specialized/compliance_gdpr.md": {
            "gdpr", "privacy", "data protection", "consent", "retention",
            "erasure", "portability", "right to access", "dpo"
        },
        "specialized/deployment_ops.md": {
            "deployment", "ci/cd", "pipeline", "docker", "kubernetes", "monitoring",
            "logging", "alerting", "health check", "scaling", "backup"
        },
    }
    ...
    def select_guardrails(
        ...
        logger.info(
            ...
            budget_usage_percent=round(total_tokens / token_budget * 100, 1),
        )
